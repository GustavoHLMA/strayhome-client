...
import { CampaignInfo, Container, Content, Dates, Description, DonateButton, Target, Title, Image, BackButton, ImageContainer } from './styles';
      ...
      <Container>
          <Content>
              <ImageContainer>
                  ...
                  <Dates>
                      Duration: <span>{formattedStartDate} | {formattedDeadline}</span>
                  </Dates>
              </ImageContainer>
              <CampaignInfo>
                  <Title>{campaign.name}</Title>
                  <Target>Target: <span>USD {campaign.target}</span></Target>
